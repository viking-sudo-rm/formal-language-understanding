...
# all_5_10 = get_conditional_probability("all", "10", "5")
# breakpoint()
...
true_matrix = np.ones([len(quantifiers), len(quantifiers)])
true_matrix[4, :] = 0
true_matrix[np.arange(len(quantifiers)), np.arange(len(quantifiers))] = 0
true_matrix[1, 0] = 0
true_matrix[1, 3] = 0
true_matrix[3, 0] = 0
